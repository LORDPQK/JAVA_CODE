...
public class EmailUtils {
	...
	private static MimeMessage createMsg(Session session, String myAccount, User user) {
		...
		try {
			//3.1发件人 from
			message.setFrom(new InternetAddress(myAccount, "松吹", "utf-8"));
			...
			message.setContent(user.getUsername()+",你好<br>欢迎注册shop商城! 请点击链接进行激活:<a href='"+url+"'>点击此处</a>","text/html;charset=utf-8");
			//设置邮件的发送时间 是立即发送
