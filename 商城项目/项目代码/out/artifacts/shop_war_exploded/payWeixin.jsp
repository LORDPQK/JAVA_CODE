...
<meta charset="utf-8">
	...
	function Pay(){
		location.href="${pageContext.request.contextPath}/Pay?method=showQRcode"
	}
	</script>
				  ...
				  <div class="panel-body">	 
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control" name="body" value="手机|配件" readonly="readonly">
							<!-- 设置 程序回传到的链接地址 -->
					...
					<div class="pull-right" style="margin-right: 30px;">
						<input type="submit" value="确认支付" onclick="Pay()" class="btn btn-warning btn-lg">
